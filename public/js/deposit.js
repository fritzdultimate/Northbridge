...
let isKycVerified = document.querySelector('.row-content').dataset.kyc == 'verified';
    ...
    if(!!amount && !!currencyIndex){
        ...
        .then((data) => {
            ...
            if('errors' in data){
                ...
                // if(currencySymbol.toLowerCase() == 'usdt') {
                //     document.querySelector(".clip-input").value = "TZ2ZUUuf4TmHzsFsuYo3HNj4Cf4a3o2pDV"
                // } else {
