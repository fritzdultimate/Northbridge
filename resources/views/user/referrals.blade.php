                            ...
                            <table class="myTable table datatables cs-table crm_customer_table_inner_Wrapper">
                                ...
                                <tbody>
                                    ...
                                    <tr class="background_white">
                                        ...
                                        <td>
                                            <div class="pretty p-svg p-curve">{{ $referral['email'] }}</div>
                                        </td>
                                        <td>
                                            <div class="pretty p-svg p-curve">{{ $referral['invested'] }}</div>
                                        </td>
                                        <td>
                                            <div class="pretty p-svg p-curve">{{ $referral['email_verified_at'] ? 'yes' : 'no' }}</div>
                                        </td>
                                        <td>
                                            <div class="pretty p-svg p-curve">{{ $referral['created_at'] }}</div>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
