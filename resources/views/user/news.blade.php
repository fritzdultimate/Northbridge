                    ...
                    <ul class="splide__list">
                        ...
                        <li class="splide__slide">
                            <a href="app-blog-post.html">
                                <div class="blog-card">
                                    <img src="{{ asset('app/img/sample/photo/1.jpg') }}" alt="image" class="imaged w-100">
                                    <div class="text">
                        ...
                        <li class="splide__slide">
                            <a href="app-blog-post.html">
                                <div class="blog-card">
                                    <img src="{{ asset('app/img/sample/photo/2.jpg') }}" alt="image" class="imaged w-100">
                                    <div class="text">
                        ...
                        <li class="splide__slide">
                            <a href="app-blog-post.html">
                                <div class="blog-card">
                                    <img src="{{ asset('app/img/sample/photo/3.jpg') }}" alt="image" class="imaged w-100">
                                    <div class="text">
                        ...
                        <li class="splide__slide">
                            <a href="app-blog-post.html">
                                <div class="blog-card">
                                    <img src="{{ asset('app/img/sample/photo/4.jpg') }}" alt="image" class="imaged w-100">
                                    <div class="text">
