            ...
            <tbody>
              <tr>
                <td class="o_bg-dark o_px o_py-md o_br-t o_sans o_text" align="center" data-bgcolor="Bg Dark" data-size="Text Default" data-min="12" data-max="20" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;background-color: #0b0c22;border-radius: 4px 4px 0px 0px;padding-left: 16px;padding-right: 16px;padding-top: 24px;padding-bottom: 24px;">
                  <p style="margin-top: 0px;margin-bottom: 0px;"><a class="o_text-white" href="{{ Request::getSchemeAndHttpHost() }}/" data-color="White" style="text-decoration: none;outline: none;color: #ffffff;"><img src="{{ asset('assets/img/favicon.png') }}" width="136" height="36" alt="{{ env('SITE_NAME') }}" style="max-width: 136px;-ms-interpolation-mode: bicubic;vertical-align: middle;border: 0;line-height: 100%;height: auto;outline: none;text-decoration: none;" data-crop="false"></a></p>
                </td>
              </tr>
            </tbody>
          </table>
              ...
              <tr>
                <td class="o_bg-dark o_px-md o_py-xl o_xs-py-md" align="center" data-bgcolor="Bg Dark" style="background-color:#050625;padding-left: 24px;padding-right: 24px;padding-top: 44px;padding-bottom: 44px;">
                  ...
                  <div class="o_col-6s o_center o_sans o_text-md o_text-white" data-color="White" data-size="Text MD" data-min="15" data-max="23" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 19px;line-height: 28px;max-width: 584px;color: #ffffff;text-align: center;">
                    ...
                    <div>
                        <a href="{{ $details['resetLink'] }}">Reset Password</a>
                    </div>
                  </div>
                  <!--[if mso]></td></tr></table><![endif]-->
                </td>
